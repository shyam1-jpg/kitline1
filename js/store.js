...
(function () {
  ...
  function seed() {
    const sites = [
      ...
      { id:'site_vedanta', name:'Vedanta Kitchen', legalName:'Vedant Way Ltd', city:'London', timezone:'Europe/London', address:'Vedant Way', postcode:'—', country:'UK', type:'Kitchen', covers:80, rating:5, manager:'Shyam Prasad', phone:'', email:'shyam_1@hotmail.co.uk', opened:'2024', lastInspection:daysAgo(10).slice(0,10), status:'Active' },
    ...
    const team = [
      { id:'u_shyam', name:'Shyam Prasad', role:'Owner — Vedant Way Ltd', email:'shyam_1@hotmail.co.uk', phone:'', siteId:'site_vedanta', initials:'SP', access:'Admin' },
    ...
    const sensors = [
      ...
      mk('s23','Walk-in Fridge — Vedanta','fridge', 4, 1, 5, 'site_vedanta', 3.4, { location:'Vedanta Kitchen', zone:'Main cold store', notes:'Vedant Way Ltd' }),
